...
test( "Find a String with particular end letter", function() {
  var strings = ["dog", "cats", "lion", "tigers"];
  deepEqual(find_string_ending_letter(strings, "s"), "cats", "should find the string in the array" );
  deepEqual(find_string_ending_letter(strings, "z"), undefined, "should find the string in the array" );
